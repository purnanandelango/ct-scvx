...
n = 05;
plant.rocket6DoF.plot_vehicle_forces(u(1:3,1:n:end),rI(:,1:n:end),vI(:,1:n:end),qBI(:,1:n:end),100,0.01,struct('scl',0.4,'rho',prb.rho,'SA',prb.SA,'CA',prb.CA),{[2,3,1],{'y','z','x'},'x'});
...
semilogy(tvec,cnstr_viol(4,:),'DisplayName','Speed','Color',[0,0.5,0]);
semilogy(tvec,cnstr_viol(5,:),'DisplayName','Tilt','Color',[0.5,0.5,0]);
semilogy(tvec,cnstr_viol(6,:),'DisplayName','Angular Vel.','Color',[0.5,0,0.5]);
semilogy(tvec,cnstr_viol(7,:),'DisplayName','Thrust gimbal','Color',[0,0.5,0.5]);
semilogy(tvec,cnstr_viol(9,:),'DisplayName','Thrust upper','Color',[0.5,0.7,0.5]);
semilogy(tvec,cnstr_viol(10,:),'DisplayName','Thrust lower','Color',[0.7,0.5,0.5]);
title("Constraint Violation")
semilogy(tvec,stc_viol(1,:),"DisplayName","Trigger",'LineStyle','--')
semilogy(tvec,stc_viol(2,:),"DisplayName","STC",'LineStyle','--')
